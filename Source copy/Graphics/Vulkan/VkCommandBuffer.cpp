...
namespace SE::Graphics
{
    ...
    void sVkCommandBuffer::EndRenderPass() { vkCmdEndRenderPass( mVkObject ); }

    void sVkCommandBuffer::SetViewport( math::ivec2 aOffset, math::uvec2 aSize )
    {
    ...
    void sVkCommandBuffer::SetScissor( math::ivec2 aOffset, math::uvec2 aSize )
    {
    ...
    void sVkCommandBuffer::Draw( uint32_t aVertexCount, uint32_t aVertexOffset, uint32_t aVertexBufferOffset, uint32_t aInstanceCount,
                                 uint32_t aFirstInstance )
    {
        vkCmdDraw( mVkObject, aVertexCount, aInstanceCount, aVertexOffset, aFirstInstance );
    }

    void sVkCommandBuffer::DrawIndexed( uint32_t aVertexCount, uint32_t aVertexOffset, uint32_t aVertexBufferOffset,
    ...
    void sVkCommandBuffer::Bind( Ref<sVkPipelineObject> aPipeline, VkPipelineBindPoint aBindPoint )
    {
        vkCmdBindPipeline( mVkObject, aBindPoint, aPipeline->mVkObject );
    }

    void sVkCommandBuffer::Bind( VkBuffer aVertexBuffer, uint32_t aBindPoint )
    {
        VkDeviceSize lOffsets[] = { 0 };
        vkCmdBindVertexBuffers( mVkObject, aBindPoint, 1, &aVertexBuffer, lOffsets );
    }

    void sVkCommandBuffer::Bind( VkBuffer aVertexBuffer, VkBuffer a_IndexBuffer, uint32_t aBindPoint )
    {
        VkDeviceSize lOffsets[] = { 0 };
        vkCmdBindVertexBuffers( mVkObject, aBindPoint, 1, &aVertexBuffer, lOffsets );
    ...
    void sVkCommandBuffer::Bind( Ref<sVkDescriptorSetObject> aDescriptorSet, VkPipelineBindPoint aBindPoint,
    ...
    void sVkCommandBuffer::ImageMemoryBarrier( VkImage aImage, VkImageLayout aOldLayout, VkImageLayout aNewLayout, uint32_t aMipCount,
    ...
    void sVkCommandBuffer::CopyBuffer( VkBuffer aSource, uint32_t aSourceOffset, uint32_t aSize, VkBuffer aDest, uint32_t aDestOffset )
    {
    ...
    void sVkCommandBuffer::CopyBuffer( VkBuffer aSource, VkImage aDestination, sImageRegion const &aBufferRegion,
                                       sImageRegion const &aImageRegion )
    {
        CopyBuffer( aSource, aDestination, { aBufferRegion }, aImageRegion );
    }

    void sVkCommandBuffer::CopyBuffer( VkBuffer aSource, VkImage aDestination, std::vector<sImageRegion> aBufferRegions,
                                       sImageRegion const &aImageRegion )
    {
    ...
    void sVkCommandBuffer::CopyImage( VkImage aSource, sImageRegion const &aSourceRegion, VkImage aDestination,
    ...
    void sVkCommandBuffer::CopyImage( VkImage aSource, VkBuffer aDestination, std::vector<sImageRegion> aImageRegions,
    ...
    void sVkCommandBuffer::End() { VK_CHECK_RESULT( vkEndCommandBuffer( mVkObject ) ); }

    void sVkCommandBuffer::SetSubmitFence( VkFence aFence ) { mSubmitFence = aFence; }

    void sVkCommandBuffer::AddWaitSemaphore( VkSemaphore aSemaphore, VkPipelineStageFlags aWaitStages )
    {
        mSubmitWaitSemaphores.push_back( aSemaphore );
        mSubmitWaitSemaphoreStage.push_back( aWaitStages );
    }

    void sVkCommandBuffer::AddSignalSemaphore( VkSemaphore aSemaphore ) { mSubmitSignalSemaphores.push_back( aSemaphore ); }
