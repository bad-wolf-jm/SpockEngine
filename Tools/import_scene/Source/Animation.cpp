...
{
    LTSE::Logging::Info( "Loading animations" );
    ...
    for( uint32_t l_AnimationIdx = 0; l_AnimationIdx < a_SceneData->mNumAnimations; l_AnimationIdx++ )
    {
        ...
        LTSE::Logging::Info( " - {}: duration={} ticks @ {} ticks/s", l_AnimationTrackData->Name, l_AnimationTrackData->TickCount, l_AnimationTrackData->TicksPerSecond );
        ...
        for( uint32_t l_NodeAnimationChannelIdx = 0; l_NodeAnimationChannelIdx < l_AnimationChannel->mNumChannels; l_NodeAnimationChannelIdx++ )
        {
            ...
            LTSE::Logging::Info( "   * {}", l_NodeAnimationChannelData.TargetNodeName );
