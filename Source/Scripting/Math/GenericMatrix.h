...
namespace numlua::core
{
    ...
    {
        auto newType = declare_primitive_type<_MatrixType>( scriptState, name );

        newType["inverse"]   = []( _MatrixType self ) -> _MatrixType { return inverse( self ); };
        newType["transpose"] = []( _MatrixType self ) -> _MatrixType { return transpose( self ); };

        //clang-format off
        newType["__add"] = []( const _MatrixType &v1, const _MatrixType &v2 ) -> _MatrixType { return v1 + v2; };
        newType["__mul"] =
