...
namespace LTSE::Editor
{
    ...
    TileLayoutEditor::TileLayoutEditor( std::string a_Title, math::vec2 a_Size )
    ...
    void TileLayoutEditor::WindowContent()
    {
        if( !Visible )
            return;
        ...
        if( ImGui::Button( "Cancel##TileLayoutEditor", ImVec2{ 150, 40 } ) )
        {
