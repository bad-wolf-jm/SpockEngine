...
#include "Developer/Scene/Importer/ImporterData.h"
...
namespace LTSE::Core::EntityComponentSystem::Components
{
    ...
    template <typename _Ty> struct Dirty
    {
    };
    ...
    struct LocalTransformComponent
    {
        ...
        {
            math::mat4 rot = math::Rotation( math::radians( a_Rotation.z ), math::z_axis() ) * math::Rotation( math::radians( a_Rotation.y ), math::y_axis() ) *
    ...
    struct DirectionalLightComponent
    {
        ...
        {
            return ( Azimuth == a_Other.Azimuth ) && ( Elevation == a_Other.Elevation ) && ( Intensity == a_Other.Intensity ) && ( Color == a_Other.Color );
        }
    };
    ...
    struct PointLightComponent
    {
        ...
        bool operator==( const PointLightComponent &a_Other ) { return ( Position == a_Other.Position ) && ( Color == a_Other.Color ) && ( Intensity == a_Other.Intensity ); }
    };
    ...
    struct SpotlightComponent
    {
        ...
        {
            return ( Position == a_Other.Position ) && ( Azimuth == a_Other.Azimuth ) && ( Elevation == a_Other.Elevation ) && ( Intensity == a_Other.Intensity ) &&
                   ( Color == a_Other.Color ) && ( Cone == a_Other.Cone );
        }
    };
