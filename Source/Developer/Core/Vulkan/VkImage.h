...
namespace LTSE::Graphics::Internal
{
    ...
    struct sVkImageObject
    {
        ...
        sVkImageObject( Ref<VkContext> aContext, uint32_t aWidth, uint32_t aHeight, uint32_t aDepth, uint32_t aMipLevels, uint32_t aLayers, uint8_t aSampleCount,
    ...
    struct sVkImageSamplerObject
    {
        ...
        sVkImageSamplerObject( Ref<VkContext> aContext, VkFilter aMinificationFilter, VkFilter aMagnificationFilter, VkSamplerAddressMode aWrappingMode,
    ...
    struct sVkImageViewObject
    {
        ...
        sVkImageViewObject( Ref<VkContext> aContext, Ref<sVkImageObject> aImageObject, uint32_t aLayerCount, VkImageViewType aViewType, VkFormat aImageFormat,
    ...
    struct sVkFramebufferImage
    {
        ...
        sVkFramebufferImage( Ref<VkContext> aContext, VkFormat aFormat, uint32_t aWidth, uint32_t aHeight, uint32_t aSampleCount, VkImageUsageFlags aUsage, bool aIsSampled );
        sVkFramebufferImage( Ref<VkContext> aContext, VkImage aImage, VkFormat aFormat, uint32_t aWidth, uint32_t aHeight, uint32_t aSampleCount, VkImageUsageFlags aUsage,
                             bool aIsSampled );
