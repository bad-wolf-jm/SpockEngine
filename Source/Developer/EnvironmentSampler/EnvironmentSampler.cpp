...
namespace LTSE::SensorModel::Dev
{
    ...
    void WorldSampler::BuildShaderBindingTable( Ref<Scene> a_Scene )
    {
        ...
        a_Scene->ForEach<LTSE::Core::EntityComponentSystem::Components::RayTracingTargetComponent, LTSE::Core::EntityComponentSystem::Components::StaticMeshComponent>(
    ...
    void WorldSampler::Sample( math::mat4 a_SensorTransform, Ref<Scene> a_Scene, MultiTensor &a_Azimuths, MultiTensor &a_Elevations, MultiTensor &a_Intensities,
                               MultiTensor &a_SamplePoints )
    {
        ...
        if( a_Scene->GetRayTracingRoot() )
        {
            ...
            LTSE::Cuda::GPUExternalMemory lTransformedVertexBuffer( *a_Scene->mTransformedVertexBuffer, a_Scene->mTransformedVertexBuffer->SizeAs<uint8_t>() );
            ...
            m_RayTracingPipeline->Launch( 0, m_LaunchParamsBuffer.RawDevicePtr(), m_LaunchParamsBuffer.Size(), m_SBT, math::uvec3{ a_Azimuths.SizeAs<float>(), 1, 1 } );
