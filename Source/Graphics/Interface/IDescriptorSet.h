    ...
    class IDescriptorSet
    {
      public:
        ...
        virtual void Write( ref_t<IGraphicBuffer> aBuffer, bool aDynamicOffset, uint32_t aOffset, uint32_t aSize,
                            uint32_t aBinding )                                            = 0;
        virtual void Write( std::vector<ref_t<ISampler2D>> aBuffer, uint32_t aBinding )      = 0;
        virtual void Write( std::vector<ref_t<ISamplerCubeMap>> aBuffer, uint32_t aBinding ) = 0;
