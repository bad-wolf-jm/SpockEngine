...
namespace SE::Graphics
{
    ...
    /** @brief */
    Texture2D::Texture2D( GraphicContext &aGraphicContext, TextureData2D &aTextureData, TextureSampler2D &aSamplingInfo )
    ...
    Texture2D::Texture2D( GraphicContext &aGraphicContext, Core::TextureData::sCreateInfo &aTextureImageDescription )
        : mGraphicContext( aGraphicContext )
