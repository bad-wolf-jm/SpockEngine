...
namespace SE::Graphics
{
    ...
    vec_t<VkClearValue> VkRenderTarget::GetClearValues()
    {
        vec_t<VkClearValue> lValues;
    ...
    {
        vec_t<sAttachmentResource> lAttachments{};
    ...
    ref_t<VkRenderPassObject> VkRenderTarget::CreateDefaultRenderPass()
    {
        ...
        vec_t<VkAttachmentDescription> lAttachmentDescriptions{};
        vec_t<VkAttachmentReference>   lColorAttachmentReferences{};
