...
namespace SE::Graphics
{
    ...
    void DescriptorSet::Write( std::vector<ref_t<VkSampler2D>> aWriteOperations, uint32_t aBinding )
    {
    ...
    void DescriptorSet::Write( ref_t<VkSampler2D> aBuffer, uint32_t aBinding ) { Write( std::vector{ aBuffer }, aBinding ); }

    void DescriptorSet::Write( std::vector<ref_t<VkSamplerCubeMap>> aWriteOperations, uint32_t aBinding )
    {
        if( aWriteOperations.size() == 0 ) return;
    ...
    void DescriptorSet::Write( ref_t<VkSamplerCubeMap> aBuffer, uint32_t aBinding ) { Write( std::vector{ aBuffer }, aBinding ); }
