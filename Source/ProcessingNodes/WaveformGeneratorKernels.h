...
namespace LTSE::SensorModel::Kernels
{
    ...
    ///
    ///
    void ResolveAbstractWaveformsOp( MultiTensor &aOut, MultiTensor &aReturnIntensities, MultiTensor &aReturnTimes, MemoryBuffer &aSummandCount, MemoryBuffer &mAPDSizes,
