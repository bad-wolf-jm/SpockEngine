...
namespace LTSE::SensorModel
{
    ...
    ///
    struct sResolveAbstractWaveforms
    {
        ...
        sResolveAbstractWaveforms()                                    = default;
        sResolveAbstractWaveforms( const sResolveAbstractWaveforms & ) = default;
    };

    struct sResolveAbstractWaveformsController : public LTSE::TensorOps::sGraphOperationController
    {
        void Run();
    };
    ...
    ///
    OpNode ResolveWaveforms( Scope &aScope, OpNode aReturnTimes, OpNode aReturnIntensities, OpNode aSamplingLength, OpNode aSamplingInterval, OpNode aPulseTemplates );
