...
namespace morph
{
    ...
    class GraphVisual : public VisualModel
    {
      public:
        ...
        ~GraphVisual()
        {
            for( auto &gdc : this->graphDataCoords )
            {
                delete gdc;
            }
        }
        ...
        void update( const std::vector<Flt> &_abscissae, const std::vector<Flt> &_data, const size_t data_idx )
        {
        ...
        static std::array<float, 3> datacolour( size_t data_index )
        {
            ...
            case 0:
            {
                rtn = morph::colour::royalblue;
                break;
            }
            case 1:
            {
                rtn = morph::colour::crimson;
                break;
            }
            case 2:
            {
                rtn = morph::colour::goldenrod2;
                break;
            }
            case 3:
            {
                rtn = morph::colour::green2;
                break;
            }

            case 4:
            {
                rtn = morph::colour::blue2;
                break;
            }
            case 5:
            {
                rtn = morph::colour::blueviolet;
                break;
            }
            case 6:
            {
                rtn = morph::colour::khaki1;
                break;
            }
            case 7:
            {
                rtn = morph::colour::sapgreen;
                break;
            }

            case 8:
            {
                rtn = morph::colour::mediumturquoise;
                break;
            }
            case 9:
            {
                rtn = morph::colour::seagreen1;
                break;
            }
            case 10:
            {
                rtn = morph::colour::darkgoldenrod4;
                break;
            }
            case 11:
            {
                rtn = morph::colour::olivedrab2;
                break;
            }

            case 12:
            {
                rtn = morph::colour::lightsteelblue3;
                break;
            }
            case 13:
            {
                rtn = morph::colour::purple;
                break;
            }
            case 14:
            {
                rtn = morph::colour::deeppink1;
                break;
            }
            case 15:
            {
                rtn = morph::colour::red2;
                break;
            }

            case 16:
            {
                rtn = morph::colour::royalblue1;
                break;
            }
            case 17:
            {
                rtn = morph::colour::mediumorchid1;
                break;
            }
            case 18:
            {
                rtn = morph::colour::lightskyblue1;
                break;
            }
            case 19:
            {
                rtn = morph::colour::firebrick1;
                break;
            }

            case 20:
            {
                rtn = morph::colour::royalblue2;
                break;
            }
            case 21:
            {
                rtn = morph::colour::mediumorchid2;
                break;
            }
            case 22:
            {
                rtn = morph::colour::lightskyblue2;
                break;
            }
            case 23:
            {
                rtn = morph::colour::firebrick2;
                break;
            }

            case 24:
            {
                rtn = morph::colour::royalblue3;
                break;
            }
            case 25:
            {
                rtn = morph::colour::mediumorchid3;
                break;
            }
            case 26:
            {
                rtn = morph::colour::lightskyblue3;
                break;
            }
            case 27:
            {
                rtn = morph::colour::firebrick3;
                break;
            }

            case 28:
            {
                rtn = morph::colour::royalblue4;
                break;
            }
            case 29:
            {
                rtn = morph::colour::mediumorchid4;
                break;
            }
            case 30:
            {
                rtn = morph::colour::lightskyblue4;
                break;
            }
            case 31:
            {
                rtn = morph::colour::firebrick4;
                break;
            }

            case 32:
            {
                rtn = morph::colour::brown1;
                break;
            }
            case 33:
            {
                rtn = morph::colour::darkolivegreen1;
                break;
            }
            case 34:
            {
                rtn = morph::colour::chocolate1;
                break;
            }
            case 35:
            {
                rtn = morph::colour::chartreuse;
                break;
            }

            case 36:
            {
                rtn = morph::colour::brown2;
                break;
            }
            case 37:
            {
                rtn = morph::colour::darkolivegreen2;
                break;
            }
            case 38:
            {
                rtn = morph::colour::chocolate2;
                break;
            }
            case 39:
            {
                rtn = morph::colour::chartreuse2;
                break;
            }

            case 40:
            {
                rtn = morph::colour::brown3;
                break;
            }
            case 41:
            {
                rtn = morph::colour::darkolivegreen3;
                break;
            }
            case 42:
            {
                rtn = morph::colour::chocolate3;
                break;
            }
            case 43:
            {
                rtn = morph::colour::chartreuse3;
                break;
            }

            case 44:
            {
                rtn = morph::colour::brown4;
                break;
            }
            case 45:
            {
                rtn = morph::colour::darkolivegreen4;
                break;
            }
            case 46:
            {
                rtn = morph::colour::chocolate4;
                break;
            }
            case 47:
            {
                rtn = morph::colour::chartreuse4;
                break;
            }
        ...
        void setdata( const std::vector<Flt> &_abscissae, const std::vector<Flt> &_data, const std::string name = "",
                      const morph::axisside axisside = morph::axisside::left )
        {
        ...
        void setdata( const std::vector<Flt> &_abscissae, const std::vector<Flt> &_data, const DatasetStyle &ds )
        {
            ...
            if( ds.axisside == morph::axisside::left )
            {
                if( this->ord1_scale.autoscaled == false )
                {
            ...
            {
                if( this->ord2_scale.autoscaled == false )
                {
                    this->compute_scaling( _abscissae, _data, ds.axisside );
                }
            }
      ...
      public:
         ...
         */
        static std::deque<Flt> maketicks( Flt rmin, Flt rmax, float realmin, float realmax, const Flt max_num_ticks = 10,
                                          const Flt min_num_ticks = 3 )
        {
            std::deque<Flt> ticks;
            ...
            {
                std::cout << "initial trytick = " << trytick << ", numticks = " << numticks << " max_num_ticks = " << max_num_ticks
                          << std::endl;
            }
            ...
            else
            {
                while( numticks < min_num_ticks && numticks < max_num_ticks )
                {
                    ...
                    if constexpr( gv_debug )
                    {
                        std::cout << "Trying reduced spacing to increase numticks. trytick = " << trytick
                                  << " and numticks= " << numticks << "\n";
                    }
                }
            }
            if constexpr( gv_debug )
      ...
      protected:
        ...
        {
            bool within = false;
            if( datapoint[0] >= 0 && datapoint[0] <= this->width && datapoint[1] >= 0 && datapoint[1] <= this->height )
            {
                within = true;
            }
            return within;
        ...
        void drawDataCommon( size_t dsi, size_t coords_start, size_t coords_end, bool appending = false )
        {
            ...
            else if( this->datastyles[dsi].showlines == true )
            {
                ...
                for( size_t i = coords_start + 1; i < coords_end; ++i )
                {
                    ...
                    if( this->draw_beyond_axes == true || ( this->within_axes( ( *this->graphDataCoords[dsi] )[i - 1] ) &&
                                                            this->within_axes( ( *this->graphDataCoords[dsi] )[i] ) ) )
                    {
                        ...
                        if( this->datastyles[dsi].markergap > 0.0f )
                        {
                            ...
                            this->computeFlatLine( this->idx, ( *this->graphDataCoords[dsi] )[i - 1],
                                                   ( *this->graphDataCoords[dsi] )[i], this->uz, this->datastyles[dsi].linecolour,
                        ...
                        else if( appending == true )
                        {
                            ...
                            this->computeFlatLineRnd( this->idx,
                                                      ...
                                                      this->uz, this->datastyles[dsi].linecolour, this->datastyles[dsi].linewidth,
                                                      0.0f, true, false );
                        }
                        else
                        {
                            ...
                            {
                                // last line
                                this->computeFlatLineP( this->idx, ( *this->graphDataCoords[dsi] )[i - 1],
                                                        ( *this->graphDataCoords[dsi] )[i], ( *this->graphDataCoords[dsi] )[i - 2],
                                                        this->uz, this->datastyles[dsi].linecolour, this->datastyles[dsi].linewidth );
                            }
                            else
                            {
                                ...
                                this->computeFlatLine( this->idx, ( *this->graphDataCoords[dsi] )[i - 1],
                                                       ( *this->graphDataCoords[dsi] )[i], ( *this->graphDataCoords[dsi] )[i - 2],
                                                       ( *this->graphDataCoords[dsi] )[i + 1], this->uz,
                                                       this->datastyles[dsi].linecolour, this->datastyles[dsi].linewidth );
                            }
                        }

                    } // else line segment is outside axes and we're not to draw it. IDEALLY I'd interpolate to draw the line UP to the
                      // axis.
                }
            }
        }
        ...
        void drawLegend()
        {
            ...
            if( !geom.empty() )
            {
                toffset[1] -= geom.back().height() / 2.0f;
            }

            // What's our legend grid arrangement going to be? Each column will advance by the text_advance, some space and the size of
            // the marker
            float col_advance = 2 * toffset[0] + text_advance;
            if( !datastyles.empty() )
            {
                col_advance += this->datastyles[0].markersize;
            }
            ...
            for( int dsi = 0; dsi < (int)gd_size; ++dsi )
            {
                ...
                if( num_cols == 0 )
                {
                    throw std::runtime_error( "GraphVisual::drawLegend: Why is num_cols 0?" );
                }
                ...
                if( this->datastyles[dsi].showlines == true && this->datastyles[dsi].markerstyle != markerstyle::bar )
                {
                    ...
                    this->computeFlatLineRnd( this->idx, lpos - abit, lpos + abit, this->uz, this->datastyles[dsi].linecolour,
        ...
        void drawAxisLabels()
        {
            ...
            { // rotate so shift by text height
        ...
        void drawTickLabels()
        {
            ...
            if( !this->omit_x_tick_labels )
            {
                for( unsigned int i = 0; i < this->xtick_posns.size(); ++i )
                {
                    ...
                    if( this->axisstyle == axisstyle::cross && this->xticks[i] == 0 )
                    {
                        continue;
                    }
                    ...
                    auto lbl =
                        std::make_unique<morph::VisualTextModel>( this->shaders.tprog, this->font, this->fontsize, this->fontres );
                    ...
                    morph::vec<float> lblpos = { (float)this->xtick_posns[i] - geom.half_width(),
                                                 y_for_xticks - ( this->ticklabelgap + geom.height() ), 0 };
            ...
            if( !this->omit_y_tick_labels )
            {
                for( unsigned int i = 0; i < this->ytick_posns.size(); ++i )
                {
                    ...
                    // Omit the 0 for 'cross' axes (or maybe shift its position)
                    if( this->axisstyle == axisstyle::cross && this->yticks[i] == 0 )
                    {
                        continue;
                    }
                    ...
                    morph::vec<float>    lblpos = { x_for_yticks - this->ticklabelgap - geom.width(),
                                                    (float)this->ytick_posns[i] - geom.half_height(), 0 };
                    std::array<float, 3> clr    = this->axiscolour;
                    if( this->axisstyle == axisstyle::twinax && this->datastyles.size() > 0 )
                    {
                        clr = this->datastyles[0].policy == stylepolicy::lines ? this->datastyles[0].linecolour
                                                                               : this->datastyles[0].markercolour;
                    }
            ...
            if( this->axisstyle == axisstyle::twinax && !this->omit_y_tick_labels )
            {
                ...
                for( unsigned int i = 0; i < this->ytick_posns2.size(); ++i )
                {
                    ...
                    morph::vec<float> lblpos = { x_for_yticks + this->ticklabelgap, (float)this->ytick_posns2[i] - geom.half_height(),
                                                 0 };
                    std::array<float, 3> clr = this->axiscolour;
                    if( this->datastyles.size() > 1 )
                    {
                        clr = this->datastyles[1].policy == stylepolicy::lines ? this->datastyles[1].linecolour
                                                                               : this->datastyles[1].markercolour;
                    }
                    lbl->setupText( s, lblpos + this->mv_offset, clr );
                    this->texts.push_back( std::move( lbl ) );
                }
        ...
        void drawCrossAxes()
        {
            ...
            float _x0_mdl = this->abscissa_scale.transform_one( 0 );
            float _y0_mdl = this->ord1_scale.transform_one( 0 );
            this->computeFlatLine( this->idx, { _x0_mdl, -( this->axislinewidth * 0.5f ), -this->thickness },
                                   { _x0_mdl, this->height + ( this->axislinewidth * 0.5f ), -this->thickness }, this->uz,
                                   this->axiscolour, this->axislinewidth * 0.7f );
            // Horz zero
            this->computeFlatLine( this->idx, { 0, _y0_mdl, -this->thickness }, { this->width, _y0_mdl, -this->thickness }, this->uz,
                                   this->axiscolour, this->axislinewidth * 0.7f );

            for( auto xt : this->xtick_posns )
            {
                // Want to place lines in screen units. So transform the data units
                this->computeFlatLine( this->idx, { (float)xt, _y0_mdl, -this->thickness },
                                       { (float)xt, _y0_mdl - this->ticklength, -this->thickness }, this->uz, this->axiscolour,
                                       this->axislinewidth * 0.5f );
            }
            for( auto yt : this->ytick_posns )
            {
                this->computeFlatLine( this->idx, { _x0_mdl, (float)yt, -this->thickness },
                                       { _x0_mdl - this->ticklength, (float)yt, -this->thickness }, this->uz, this->axiscolour,
                                       this->axislinewidth * 0.5f );
            }
        }
        ...
        void drawAxes()
        {
            ...
            if( this->axisstyle == axisstyle::box || this->axisstyle == axisstyle::twinax ||
                this->axisstyle == axisstyle::boxfullticks || this->axisstyle == axisstyle::boxcross ||
                this->axisstyle == axisstyle::L )
            {

                // y axis
                this->computeFlatLine( this->idx, { 0, -( this->axislinewidth * 0.5f ), -this->thickness },
                                       { 0, this->height + this->axislinewidth * 0.5f, -this->thickness }, this->uz, this->axiscolour,
                                       this->axislinewidth );
                // x axis
                this->computeFlatLine( this->idx, { 0, 0, -this->thickness }, { this->width, 0, -this->thickness }, this->uz,
                                       this->axiscolour, this->axislinewidth );
                ...
                {
                    // Want to place lines in screen units. So transform the data units
                    this->computeFlatLine( this->idx, { (float)xt, 0.0f, -this->thickness }, { (float)xt, tl, -this->thickness },
                                           this->uz, this->axiscolour, this->axislinewidth * 0.5f );
                }
                for( auto yt : this->ytick_posns )
                {
                    this->computeFlatLine( this->idx, { 0.0f, (float)yt, -this->thickness }, { tl, (float)yt, -this->thickness },
                                           this->uz, this->axiscolour, this->axislinewidth * 0.5f );
                }
            }
            ...
            {
                // right axis
                this->computeFlatLine( this->idx, { this->width, -this->axislinewidth * 0.5f, -this->thickness },
                                       { this->width, this->height + ( this->axislinewidth * 0.5f ), -this->thickness }, this->uz,
                                       this->axiscolour, this->axislinewidth );
                // top axis
                this->computeFlatLine( this->idx, { 0, this->height, -this->thickness },
                                       { this->width, this->height, -this->thickness }, this->uz, this->axiscolour,
                                       this->axislinewidth );
                ...
                if( this->axisstyle == axisstyle::boxfullticks )
                {
                    ...
                    {
                        // Want to place lines in screen units. So transform the data units
                        this->computeFlatLine( this->idx, { (float)xt, this->height, -this->thickness },
                                               { (float)xt, this->height + tl, -this->thickness }, this->uz, this->axiscolour,
                                               this->axislinewidth * 0.5f );
                    }
                    for( auto yt : this->ytick_posns )
                    {
                        this->computeFlatLine( this->idx, { this->width, (float)yt, -this->thickness },
                                               { this->width + tl, (float)yt, -this->thickness }, this->uz, this->axiscolour,
                                               this->axislinewidth * 0.5f );
                    }
                }
                ...
                if( this->axisstyle == axisstyle::boxcross )
                {
                    this->drawCrossAxes();
                }
            }
        ...
        {
            p[2] += this->thickness;
            this->computeFlatPoly( this->idx, p, this->ux, this->uy, style.markercolour, style.markersize * Flt{ 0.5 }, n );
        }
        ...
        void polygonFlattop( morph::vec<float> p, int n, const morph::DatasetStyle &style )
        {
            p[2] += this->thickness;
            this->computeFlatPoly( this->idx, p, this->ux, this->uy, style.markercolour, style.markersize * Flt{ 0.5 }, n,
                                   morph::mathconst<float>::pi / static_cast<float>( n ) );
        }
