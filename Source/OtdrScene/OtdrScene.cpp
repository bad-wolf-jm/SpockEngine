...
// #include "OtdrScene/Components/VisualHelpers.h"
...
namespace SE::Core
{
    ...
    {
        // mMaterialSystem = New<MaterialSystem>( aGraphicContext );
    ...
    // void OtdrScene::ResizeCUDABuffers()
    // {
    ...
    // math::mat4 OtdrScene::GetProjection()
    // {
    ...
    // math::vec3 OtdrScene::GetCameraPosition()
    // {
    ...
    // math::mat4 OtdrScene::GetFinalTransformMatrix( Element aElement )
    // {
    ...
    // OtdrScene::Element OtdrScene::LoadModel( Ref<sImportedModel> aModelData, math::mat4 aTransform )
    // {
    ...
    // OtdrScene::Element OtdrScene::LoadModel( Ref<sImportedModel> aModelData, math::mat4 aTransform, std::string aName )
    // {
    //     auto lAssetEntity = mRegistry.CreateEntity( Root, aName );
    ...
    // void OtdrScene::MarkAsRayTracingTarget( OtdrScene::Element aElement )
    // {
    ...
    // void OtdrScene::UpdateAnimation( Entity &aEntity, Timestep const &ts )
    // {
    ...
    // void OtdrScene::UpdateRayTracingComponents()
    // {
    //     SE_PROFILE_FUNCTION();
    ...
    // void OtdrScene::RebuildAccelerationStructure()
    // {
    //     SE_PROFILE_FUNCTION();
    ...
    // void OtdrScene::InitializeRayTracing()
    // {
    //     mRayTracingContext     = SE::Core::New<OptixDeviceContextObject>();
    //     mAccelerationStructure = SE::Core::New<OptixScene>( mRayTracingContext );
    // }

    // void OtdrScene::Render() {}
