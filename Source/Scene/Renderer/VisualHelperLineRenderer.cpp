...
namespace LTSE::Graphics
{
    ...
    VisualHelperLineRenderer::VisualHelperLineRenderer( GraphicContext &a_GraphicContext, VisualHelperLineRendererCreateInfo a_CreateInfo )
    ...
    void VisualHelperLineRenderer::Render( math::mat4 a_Model, math::mat4 a_View, math::mat4 a_Projection, math::vec3 a_Color, Ref<Buffer> a_VertexBuffer,
