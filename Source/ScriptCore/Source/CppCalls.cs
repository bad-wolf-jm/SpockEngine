...
namespace SpockEngine
{
    public static class CppCall
    {
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateMultiTensor_Constant_Initializer(Scope aScope, Type aType, object aInitializer, sTensorShape aShape);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateMultiTensor_Vector_Initializer<_Ty>(Scope aScope, Type aType, _Ty[] aInitializer, sTensorShape aShape);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateMultiTensor_Data_Initializer<_Ty>(Scope aScope, Type aType, _Ty[] aInitializer, sTensorShape aShape);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateMultiTensor_Random_Normal_Initializer(Scope aScope, Type aType, object aMean, object aStd, sTensorShape aShape);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateMultiTensor_Random_Uniform_Initializer(Scope aScope, Type aType, sTensorShape aShape);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateVector<_Ty>(Scope aScope, _Ty[] aInitializer);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateScalarVector<_Ty>(Scope aScope, Type aType, _Ty[] aInitializer);

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal extern static uint OpNode_CreateScalarValue(Scope aScope, Type aType, object aInitializer);
