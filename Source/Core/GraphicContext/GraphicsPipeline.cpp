...
namespace SE::Graphics
{
        ...
        : mGraphicContext( a_GraphicContext )
    {
        ...
        m_PipelineLayoutObject = SE::Core::New<Internal::sVkPipelineLayoutObject>( mGraphicContext.mContext, l_DescriptorSetLayouts,
                                                                                   a_CreateInfo.PushConstants );
        ...
        if( a_CreateInfo.Opaque )
        {
            ...
            m_PipelineObject = SE::Core::New<Internal::sVkPipelineObject>(
                mGraphicContext.mContext, a_CreateInfo.SampleCount, a_CreateInfo.InputBufferLayout, a_CreateInfo.InstanceBufferLayout,
