...
namespace SE::Core
{
    ...
    // void UIFontManager::SetupRenderState( ARenderContext &aRenderContext, ImDrawData *aDrawData )
    // {
    //     SE_PROFILE_FUNCTION();
    ...
    // Render function
    // void UIFontManager::RenderDrawData( ARenderContext &aRenderContext, ImDrawData *aDrawData )
    // {
    //     SE_PROFILE_FUNCTION();
    ...
    UIFontManager::UIFontManager( Ref<SE::Core::IWindow> aWindow, Ref<VkGraphicContext> aGraphicContext,
                                  ARenderContext &aRenderContext, std::string &aImGuiConfigPath,
        ...
        // , mImGuiConfigPath{ aImGuiConfigPath }
    {
        ...
        // mMonoFont =
        //     io.Fonts->AddFontFromFileTTF( aUIConfiguration.mMonoFont.string().c_str(), aUIConfiguration.mFontSize, 0, lCharRanges );
        // io.Fonts->AddFontFromFileTTF( aUIConfiguration.mIconFont.string().c_str(), aUIConfiguration.mFontSize, &lFontConfig, lRanges );

        // mMainFont =
        //     io.Fonts->AddFontFromFileTTF( aUIConfiguration.mMainFont.string().c_str(), aUIConfiguration.mFontSize, 0, lCharRanges );
        // io.Fonts->AddFontFromFileTTF( aUIConfiguration.mIconFont.string().c_str(), aUIConfiguration.mFontSize, &lFontConfig, lRanges );

        // mBoldFont =
        //     io.Fonts->AddFontFromFileTTF( aUIConfiguration.mBoldFont.string().c_str(), aUIConfiguration.mFontSize, 0, lCharRanges );
        // io.Fonts->AddFontFromFileTTF( aUIConfiguration.mIconFont.string().c_str(), aUIConfiguration.mFontSize, &lFontConfig, lRanges );

        // mObliqueFont =
        //     io.Fonts->AddFontFromFileTTF( aUIConfiguration.mItalicFont.string().c_str(), aUIConfiguration.mFontSize, 0, lCharRanges );
        // io.Fonts->AddFontFromFileTTF( aUIConfiguration.mIconFont.string().c_str(), aUIConfiguration.mFontSize, &lFontConfig, lRanges );
    ...
    void UIFontManager::EndFrame( ARenderContext &aRenderContext )
    {
        // ImGui::PopFont();
        // ImGui::Render();
    ...
    // ImageHandle UIFontManager::CreateTextureHandle( Ref<VkSampler2D> aTexture ) { return ImageHandle{ AddTexture( aTexture ) }; }

    // ImGuiIO &UIFontManager::GetIO()
    // {
    //     ImGui::SetCurrentContext( mImGUIOverlay );
    //     return ImGui::GetIO();
    // }

    // void UIFontManager::PushFontFamily( FontFamily aFamily )
    // {
    ...
    // void UIFontManager::PopFont() { ImGui::PopFont(); }

    // Ref<DescriptorSet> UIFontManager::AddTexture( Ref<VkSampler2D> aTexture )
    // {
