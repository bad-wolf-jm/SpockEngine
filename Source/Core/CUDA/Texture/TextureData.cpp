...
namespace numlua::core
{
    static const format ToGliType( const color_format &aFormat )
    {
        ...
        case color_format::R32_FLOAT:
            return FORMAT_R32_SFLOAT_PACK32;
        case color_format::RG32_FLOAT:
            return FORMAT_RG32_SFLOAT_PACK32;
        case color_format::RGB32_FLOAT:
            return FORMAT_RGB32_SFLOAT_PACK32;
        case color_format::RGBA32_FLOAT:
            return FORMAT_RGBA32_SFLOAT_PACK32;
        case color_format::R16_FLOAT:
            return FORMAT_R16_SFLOAT_PACK16;
        case color_format::RG16_FLOAT:
            return FORMAT_RG16_SFLOAT_PACK16;
        case color_format::RGB16_FLOAT:
            return FORMAT_RGB16_SFLOAT_PACK16;
        case color_format::RGBA16_FLOAT:
            return FORMAT_RGBA16_SFLOAT_PACK16;
        case color_format::R8_UNORM:
            return FORMAT_R8_UNORM_PACK8;
        case color_format::RG8_UNORM:
            return FORMAT_RG8_UNORM_PACK8;
        case color_format::RGB8_UNORM:
            return FORMAT_RGB8_UNORM_PACK8;
        case color_format::RGBA8_UNORM:
            return FORMAT_RGBA8_UNORM_PACK8;
        case color_format::D16_UNORM:
            return FORMAT_D16_UNORM_PACK16;
        case color_format::X8_D24_UNORM_PACK32:
            return FORMAT_D24_UNORM_PACK32;
        case color_format::D32_SFLOAT:
            return FORMAT_D32_SFLOAT_PACK32;
        case color_format::S8_UINT:
            return FORMAT_R8_SNORM_PACK8;
        case color_format::D16_UNORM_S8_UINT:
            return FORMAT_D16_UNORM_S8_UINT_PACK32;
        case color_format::D24_UNORM_S8_UINT:
            return FORMAT_D24_UNORM_S8_UINT_PACK32;
        case color_format::D32_UNORM_S8_UINT:
            return FORMAT_D32_SFLOAT_S8_UINT_PACK64;
        default:
    ...
    static const color_format ToLtseType( const format &aFormat )
    {
        ...
        case FORMAT_R32_SFLOAT_PACK32:
            return color_format::R32_FLOAT;
        case FORMAT_RG32_SFLOAT_PACK32:
            return color_format::RG32_FLOAT;
        case FORMAT_RGB32_SFLOAT_PACK32:
            return color_format::RGB32_FLOAT;
        case FORMAT_RGBA32_SFLOAT_PACK32:
            return color_format::RGBA32_FLOAT;
        case FORMAT_R16_SFLOAT_PACK16:
            return color_format::R16_FLOAT;
        case FORMAT_RG16_SFLOAT_PACK16:
            return color_format::RG16_FLOAT;
        case FORMAT_RGB16_SFLOAT_PACK16:
            return color_format::RGB16_FLOAT;
        case FORMAT_RGBA16_SFLOAT_PACK16:
            return color_format::RGBA16_FLOAT;
        case FORMAT_R8_UNORM_PACK8:
            return color_format::R8_UNORM;
        case FORMAT_RG8_UNORM_PACK8:
            return color_format::RG8_UNORM;
        case FORMAT_RGB8_UNORM_PACK8:
            return color_format::RGB8_UNORM;
        case FORMAT_RGBA8_UNORM_PACK8:
            return color_format::RGBA8_UNORM;
        case FORMAT_D16_UNORM_PACK16:
            return color_format::D16_UNORM;
        case FORMAT_D24_UNORM_PACK32:
            return color_format::X8_D24_UNORM_PACK32;
        case FORMAT_D32_SFLOAT_PACK32:
            return color_format::D32_SFLOAT;
        case FORMAT_R8_SNORM_PACK8:
            return color_format::S8_UINT;
        case FORMAT_D16_UNORM_S8_UINT_PACK32:
            return color_format::D16_UNORM_S8_UINT;
        case FORMAT_D24_UNORM_S8_UINT_PACK32:
            return color_format::D24_UNORM_S8_UINT;
        case FORMAT_D32_SFLOAT_S8_UINT_PACK64:
            return color_format::D32_UNORM_S8_UINT;
        default:
            return color_format::UNDEFINED;
        }
    }
    ...
    TextureSampler2D::TextureSampler2D( TextureData2D const &aTexture, texture_sampling_info_t const &aSamplingInfo )
        : sampler2d<float>( aTexture.mInternalTexture2d, ToGliType( aSamplingInfo.mWrapping ), ToGliType( aSamplingInfo.mMipFilter ),
                            ToGliType( aSamplingInfo.mFilter ),
                            vec4{ aSamplingInfo.mBorderColor[0], aSamplingInfo.mBorderColor[1], aSamplingInfo.mBorderColor[2],
