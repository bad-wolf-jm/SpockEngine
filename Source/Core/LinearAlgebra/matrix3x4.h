...
namespace numlua::linalg
{
    ...
    // LINALG_FUNCTION matrix<3, 4, T> operator+( matrix<3, 4, T> const &m );
    ...
    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<3, 4, T> operator+( matrix<3, 4, T> const &m, T scalar );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<3, 4, T> operator+( matrix<3, 4, T> const &m1, matrix<3, 4, T> const &m2 );
    ...
    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<3, 4, T> operator*( T scalar, matrix<3, 4, T> const &m );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION typename matrix<3, 4, T>::col_type operator*( matrix<3, 4, T> const                    &m,
    //                                                               typename matrix<3, 4, T>::row_type const &v );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION typename matrix<3, 4, T>::row_type operator*( typename matrix<3, 4, T>::col_type const &v,
    //                                                               matrix<3, 4, T> const                    &m );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<4, 4, T> operator*( matrix<3, 4, T> const &m1, matrix<4, 3, T> const &m2 );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<2, 4, T> operator*( matrix<3, 4, T> const &m1, matrix<2, 3, T> const &m2 );

    // template <typename T, qualifier Q>
    // LINALG_FUNCTION matrix<3, 4, T> operator*( matrix<3, 4, T> const &m1, matrix<3, 3, T> const &m2 );
    ...
    // template <typename T, qualifier Q>
    // LINALG_FUNCTION bool operator==( matrix<3, 4, T> const &m1, matrix<3, 4, T> const &m2 );
