namespace numlua::core
{
    ...
    template <typename vec_type>
    inline void transform( texture1d_array &Out, texture1d_array const &In0, texture1d_array const &In1,
    ...
    template <typename vec_type>
    inline void transform( texture2d_array &Out, texture2d_array const &In0, texture2d_array const &In1,
                           typename transform_func<vec_type>::type Func )
    {
    ...
    template <typename vec_type>
    inline void transform( texture_cube &Out, texture_cube const &In0, texture_cube const &In1,
                           typename transform_func<vec_type>::type Func )
    {
    ...
    template <typename vec_type>
    inline void transform( texture_cube_array &Out, texture_cube_array const &In0, texture_cube_array const &In1,
                           typename transform_func<vec_type>::type Func )
    {
