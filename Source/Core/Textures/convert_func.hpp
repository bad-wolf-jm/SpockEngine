...
namespace numlua::core
{
    namespace detail
    {
        ...
        {
            static genType load( texture1d const &Texture, texture1d::extent_type const &TexelCoord, texture1d::size_type Layer,
                                 texture1d::size_type Face, texture1d::size_type Level )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
                return Texture.load<genType>( TexelCoord, Level );
            }

            static void store( texture1d &Texture, texture1d::extent_type const &TexelCoord, texture1d::size_type Layer,
                               texture1d::size_type Face, texture1d::size_type Level, genType const &Texel )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
        ...
        {
            static genType load( texture1d_array const &Texture, texture1d_array::extent_type const &TexelCoord,
                                 texture1d_array::size_type Layer, texture1d_array::size_type Face, texture1d_array::size_type Level )
            {
                GLI_ASSERT( Face == 0 );
                return Texture.load<genType>( TexelCoord, Layer, Level );
            }

            static void store( texture1d_array &Texture, texture1d_array::extent_type const &TexelCoord,
                               texture1d_array::size_type Layer, texture1d_array::size_type Face, texture1d_array::size_type Level,
                               genType const &Texel )
            {
                GLI_ASSERT( Face == 0 );
        ...
        {
            static genType load( texture2d const &Texture, texture2d::extent_type const &TexelCoord, texture2d::size_type Layer,
                                 texture2d::size_type Face, texture2d::size_type Level )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
                return Texture.load<genType>( TexelCoord, Level );
            }

            static void store( texture2d &Texture, texture2d::extent_type const &TexelCoord, texture2d::size_type Layer,
                               texture2d::size_type Face, texture2d::size_type Level, genType const &Texel )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
                Texture.store<genType>( TexelCoord, Level, Texel );
            }
        ...
        {
            static genType load( texture2d_array const &Texture, texture2d_array::extent_type const &TexelCoord,
                                 texture2d_array::size_type Layer, texture2d_array::size_type Face, texture2d_array::size_type Level )
            {
                GLI_ASSERT( Face == 0 );
                return Texture.load<genType>( TexelCoord, Layer, Level );
            }

            static void store( texture2d_array &Texture, texture2d_array::extent_type const &TexelCoord,
                               texture2d_array::size_type Layer, texture2d_array::size_type Face, texture2d_array::size_type Level,
                               genType const &Texel )
            {
                GLI_ASSERT( Face == 0 );
        ...
        {
            static genType load( texture3d const &Texture, texture3d::extent_type const &TexelCoord, texture3d::size_type Layer,
                                 texture3d::size_type Face, texture3d::size_type Level )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
                return Texture.load<genType>( TexelCoord, Level );
            }

            static void store( texture3d &Texture, texture3d::extent_type const &TexelCoord, texture3d::size_type Layer,
                               texture3d::size_type Face, texture3d::size_type Level, genType const &Texel )
            {
                GLI_ASSERT( Layer == 0 && Face == 0 );
                Texture.store<genType>( TexelCoord, Level, Texel );
            }
        ...
        {
            static genType load( texture_cube const &Texture, texture_cube::extent_type const &TexelCoord,
            ...
            static void store( texture_cube &Texture, texture_cube::extent_type const &TexelCoord, texture_cube::size_type Layer,
                               texture_cube::size_type Face, texture_cube::size_type Level, genType const &Texel )
            {
                GLI_ASSERT( Layer == 0 );
        ...
        {
            static genType load( texture_cube_array const &Texture, texture_cube_array::extent_type const &TexelCoord,
            ...
            static void store( texture_cube_array &Texture, texture_cube_array::extent_type const &TexelCoord,
                               texture_cube_array::size_type Layer, texture_cube_array::size_type Face,
                               texture_cube_array::size_type Level, genType const &Texel )
            {
        ...
        template <typename textureType, typename retType, length_t L, typename T, qualifier P, convertMode mode = CONVERT_MODE_CAST,
                  bool isSamplerFloat = false>
        struct convertFunc
        {
            typedef accessFunc<textureType, vec<L, T, P>> access;

            static vec<4, retType, P> fetch( textureType const &Texture, typename textureType::extent_type const &TexelCoord,
            ...
            static void write( textureType &Texture, typename textureType::extent_type const &TexelCoord,
                               typename textureType::size_type Layer, typename textureType::size_type Face,
        ...
        struct convertFunc<textureType, retType, L, T, P, CONVERT_MODE_SRGB, true>
        {
                                             ...
                                             typename textureType::size_type Level )
            {
                ...
                return glm::make_vec4<retType, P>(
                               ...
                               typename textureType::size_type Level, vec<4, retType, P> const &Texel )
            {
                ...
                access::store( Texture, TexelCoord, Layer, Face, Level,
                               numlua::core::compScale<T>( convertLinearToSRGB( vec<L, retType, P>( Texel ) ) ) );
            }
        };
        ...
        {
            typedef accessFunc<numlua::core::texture2d, uint32> access;

            static vec<4, retType, P> fetch( textureType const &Texture, numlua::core::extent1d const &TexelCoord,
                                             typename textureType::size_type Layer, typename textureType::size_type Face,
                                             typename textureType::size_type Level )
            {
            ...
            static vec<4, retType, P> fetch( textureType const &Texture, numlua::core::extent2d const &TexelCoord,
                                             typename textureType::size_type Layer, typename textureType::size_type Face,
                                             typename textureType::size_type Level )
            {
                numlua::core::extent3d TexelCoord3d( TexelCoord, 0 );
                return fetch( Texture, TexelCoord3d, Layer, Face, Level );
            }

            static vec<4, retType, P> fetch( textureType const &Texture, numlua::core::extent3d const &TexelCoord,
                                             typename textureType::size_type Layer, typename textureType::size_type Face,
                                             typename textureType::size_type Level )
            {
                static_assert( std::numeric_limits<retType>::is_iec559, "CONVERT_MODE_DXT1UNORM requires an float sampler" );

                if( Texture.target() == numlua::core::TARGET_1D || Texture.target() == numlua::core::TARGET_1D_ARRAY )
                {
                    return glm::vec<4, retType, P>( 0, 0, 0, 1 );
                }

                const dxt1_block             *Data          = Texture.template data<dxt1_block>( Layer, Face, Level );
                const numlua::core::extent3d &BlockExtent   = block_extent( Texture.format() );
                ...
                numlua::core::extent3d        BlockCoord( TexelCoord / BlockExtent );
        ...
        struct convert
        {
            typedef vec<4, samplerValType, P> ( *fetchFunc )( textureType const                       &Texture,
                                                              typename textureType::extent_type const &TexelCoord,
                                                              typename textureType::size_type          Layer,
                                                              typename textureType::size_type          Face,
                                                              typename textureType::size_type          Level );
            typedef void ( *writeFunc )( textureType &Texture, typename textureType::extent_type const &TexelCoord,
                                         typename textureType::size_type Layer, typename textureType::size_type Face,
                                         typename textureType::size_type Level, vec<4, samplerValType, P> const &Texel );

            template <length_t L, typename T, convertMode mode>
            struct conv
            {
                static vec<4, samplerValType, P> fetch( textureType const                       &Texture,
                                                        typename textureType::extent_type const &TexelCoord,
                                                        typename textureType::size_type Layer, typename textureType::size_type Face,
                                                        typename textureType::size_type Level )
                {
                ...
                static void write( textureType &Texture, typename textureType::extent_type const &TexelCoord,
                                   ...
                                   typename textureType::size_type Level, vec<4, samplerValType, P> const &Texel )
                {
                    convertFunc<textureType, samplerValType, L, T, P, mode, std::numeric_limits<samplerValType>::is_iec559>::write(
                        Texture, TexelCoord, Layer, Face, Level, Texel );
                }
            };
