...
namespace numlua::core
{
    ...
    class image
    {
      ...
      public:
        ...
        /// If the type of genType doesn't match the type of the image format, no conversion is performed and the data will be
        /// reinterpreted as if is was of the image format.
        template <typename genType>
