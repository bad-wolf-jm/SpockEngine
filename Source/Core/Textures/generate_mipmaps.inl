...
namespace numlua::core
{
    ...
    inline texture1d_array generate_mipmaps( texture1d_array const &Texture, texture1d_array::size_type BaseLayer,
    ...
    inline texture2d_array generate_mipmaps( texture2d_array const &Texture, texture2d_array::size_type BaseLayer,
    ...
    inline texture_cube generate_mipmaps( texture_cube const &Texture, texture_cube::size_type BaseFace,
                                          texture_cube::size_type MaxFace, texture_cube::size_type BaseLevel,
                                          texture_cube::size_type MaxLevel, filter Minification )
    {
    ...
    inline texture_cube_array generate_mipmaps( texture_cube_array const &Texture, texture_cube_array::size_type BaseLayer,
    ...
    {
        return generate_mipmaps( Texture, Texture.base_layer(), Texture.max_layer(), Texture.base_level(), Texture.max_level(),
                                 Minification );
    }
