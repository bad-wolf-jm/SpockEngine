...
namespace numlua::core
{
    ...
    inline texture1d::texture1d( format_type Format, extent_type const &Extent, swizzles_type const &Swizzles )
        : texture( TARGET_1D, Format, texture::extent_type( Extent.x, 1, 1 ), 1, 1, numlua::core::levels( Extent ), Swizzles )
    {
    }
    ...
    inline texture1d::texture1d( texture const &Texture, format_type Format, size_type BaseLayer, size_type MaxLayer,
    ...
    inline texture1d::texture1d( texture1d const &Texture, size_type BaseLevel, size_type MaxLevel )
