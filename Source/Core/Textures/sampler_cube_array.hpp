...
namespace numlua::core
{
    ...
    /// @tparam T Sampler can fetch, write and interpret any texture format but will expose and process the data through type T
    /// conversions.
    ...
    class sampler_cube_array : public sampler
    {
      ...
      public:
        ...
        sampler_cube_array( texture_type const &Texture, wrap Wrap, filter Mip = FILTER_NEAREST, filter Min = FILTER_NEAREST,
        ...
        void generate_mipmaps( size_type BaseLayer, size_type MaxLayer, size_type BaseFace, size_type MaxFace, size_type BaseLevel,
      ...
      private:
        ...
        typedef typename detail::filterBase<detail::DIMENSION_2D, texture_type, interpolate_type, normalized_type, fetch_type,
