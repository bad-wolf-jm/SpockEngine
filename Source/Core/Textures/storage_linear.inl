namespace numlua::core
{
    ...
    inline storage_linear::storage_linear( format_type Format, extent_type const &Extent, size_type Layers, size_type Faces,
                                           size_type Levels )
        : Layers( Layers )
        , Faces( Faces )
        , Levels( Levels )
    ...
    inline storage_linear::extent_type storage_linear::extent( size_type Level ) const
    {
        ...
        return glm::max( this->Extent >> storage_linear::extent_type( static_cast<storage_linear::extent_type::value_type>( Level ) ),
    ...
    inline storage_linear::size_type storage_linear::layer_size( size_type BaseFace, size_type MaxFace, size_type BaseLevel,
