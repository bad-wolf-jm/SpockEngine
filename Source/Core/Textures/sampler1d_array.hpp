...
namespace numlua::core
{
    ...
    class sampler1d_array : public sampler
    {
      ...
      public:
        ...
        sampler1d_array( texture_type const &Texture, wrap Wrap, filter Mip = FILTER_NEAREST, filter Min = FILTER_NEAREST,
      ...
      private:
        ...
        typedef typename detail::filterBase<detail::DIMENSION_1D, texture_type, interpolate_type, normalized_type, fetch_type,
