...
namespace numlua::core
{
    ...
    inline bool save_dds( texture const &Texture, std::vector<char> &Memory )
    {
        ...
        bool const RequireDX10Header = DXFormat.D3DFormat == dx::D3DFMT_GLI1 || DXFormat.D3DFormat == dx::D3DFMT_DX10 ||
        ...
        if( RequireDX10Header )
        {
            ...
            Header10.MiscFlag          = Texture.faces() > 1 ? detail::D3D10_RESOURCE_MISC_TEXTURECUBE
                                                             : 0; // Storage.levels() > 0 ? detail::D3D10_RESOURCE_MISC_GENERATE_MIPS : 0;
