...
namespace numlua::core
{
    ...
    template <typename T, qualifier P>
    inline typename sampler_cube<T, P>::texel_type sampler_cube<T, P>::texel_fetch( extent_type const &TexelCoord, size_type Face,
    ...
    template <typename T, qualifier P>
    inline void sampler_cube<T, P>::texel_write( extent_type const &TexelCoord, size_type Face, size_type Level,
    ...
    template <typename T, qualifier P>
    inline typename sampler_cube<T, P>::texel_type sampler_cube<T, P>::texture_lod( normalized_type const &SampleCoord, size_type Face,
    ...
    template <typename T, qualifier P>
    inline void sampler_cube<T, P>::generate_mipmaps( size_type BaseFace, size_type MaxFace, size_type BaseLevel, size_type MaxLevel,
                                                      filter Minification )
    {
        GLI_ASSERT( !this->Texture.empty() );
