...
namespace numlua::core
{
    ...
    template <typename T, qualifier P>
    inline typename sampler1d<T, P>::texel_type sampler1d<T, P>::texel_fetch( extent_type const &TexelCoord,
    ...
    template <typename T, qualifier P>
    inline typename sampler1d<T, P>::texel_type sampler1d<T, P>::texture_lod( normalized_type const &SampleCoord,
