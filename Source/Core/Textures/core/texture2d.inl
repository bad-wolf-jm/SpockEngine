...
namespace numlua::core
{
    ...
    inline texture2d::texture2d( format_type Format, extent_type const &Extent, swizzles_type const &Swizzles )
        : texture( TARGET_2D, Format, texture::extent_type( Extent, 1 ), 1, 1, numlua::core::levels( Extent ), Swizzles )
    {
    }
    ...
    inline texture2d::texture2d( texture const &Texture, format_type Format, size_type BaseLayer, size_type MaxLayer,
    ...
    inline texture2d::texture2d( texture2d const &Texture, size_type BaseLevel, size_type MaxLevel )
