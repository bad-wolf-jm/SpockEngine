namespace numlua::core
{
    namespace detail
    {
        inline void duplicate_images( texture const &Src, texture &Dst, texture::size_type BaseLayer, texture::size_type MaxLayer,
    ...
    {
        texture Duplicate( Texture.target(), Texture.format(), Texture.extent(), Texture.layers(), Texture.faces(), Texture.levels() );

        detail::duplicate_images( Texture, Duplicate, 0, Texture.layers() - 1, 0, Texture.faces() - 1, 0, Texture.levels() - 1 );
    ...
    inline texture duplicate( texture1d const &Texture, texture1d::size_type BaseLevel, texture1d::size_type MaxLevel )
    {
    ...
    inline texture duplicate( texture1d_array const &Texture, texture1d_array::size_type BaseLayer,
    ...
    inline texture duplicate( texture2d const &Texture, texture2d::size_type BaseLevel, texture2d::size_type MaxLevel )
    {
        GLI_ASSERT( BaseLevel <= MaxLevel );
        GLI_ASSERT( BaseLevel < Texture.levels() );
        GLI_ASSERT( MaxLevel < Texture.levels() );
                              ...
                              texture2d_array::size_type MaxLevel )
    {
        ...
        texture2d_array Duplicate( Texture.format(), Texture.extent( BaseLevel ), MaxLayer - BaseLayer + 1, MaxLevel - BaseLevel + 1 );
    ...
    inline texture duplicate( texture3d const &Texture, texture3d::size_type BaseLevel, texture3d::size_type MaxLevel )
    {
        GLI_ASSERT( BaseLevel <= MaxLevel );
        GLI_ASSERT( BaseLevel < Texture.levels() );
        GLI_ASSERT( MaxLevel < Texture.levels() );
    ...
    inline texture duplicate( texture_cube const &Texture, texture_cube::size_type BaseFace, texture_cube::size_type MaxFace,
    ...
    inline texture duplicate( texture_cube_array const &Texture, texture_cube_array::size_type BaseLayer,
                              ...
                              texture_cube_array::size_type MaxLevel )
    {
        ...
        texture_cube_array Duplicate( Texture.format(), Texture[BaseLayer][BaseFace].extent( BaseLevel ), MaxLayer - BaseLayer + 1,
                                      MaxLevel - BaseLevel + 1 );
