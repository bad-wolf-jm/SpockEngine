...
namespace numlua::core
{
    ...
    template <typename T, qualifier P>
    inline typename sampler2d_array<T, P>::texel_type sampler2d_array<T, P>::texel_fetch( extent_type const &TexelCoord,
    ...
    template <typename T, qualifier P>
    inline void sampler2d_array<T, P>::texel_write( extent_type const &TexelCoord, size_type layer, size_type Level,
    ...
    template <typename T, qualifier P>
    inline typename sampler2d_array<T, P>::texel_type sampler2d_array<T, P>::texture_lod( normalized_type const &SampleCoord,
