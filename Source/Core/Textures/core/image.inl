namespace numlua::core
{
    namespace detail
    {
        inline size_t texel_linear_addressing( extent1d const &Extent, extent1d const &TexelCoord )
        {
        ...
        inline size_t texel_linear_addressing( extent2d const &Extent, extent2d const &TexelCoord )
        {
        ...
        inline size_t texel_linear_addressing( extent3d const &Extent, extent3d const &TexelCoord )
        {
            GLI_ASSERT( TexelCoord.x < Extent.x );
            GLI_ASSERT( TexelCoord.y < Extent.y );
        ...
        inline size_t texel_morton_addressing( extent1d const &Extent, extent1d const &TexelCoord )
        {
            GLI_ASSERT( TexelCoord.x < Extent.x );
        ...
        inline size_t texel_morton_addressing( extent2d const &Extent, extent2d const &TexelCoord )
        {
        ...
        inline size_t texel_morton_addressing( extent3d const &Extent, extent3d const &TexelCoord )
        {
            GLI_ASSERT( TexelCoord.x < Extent.x );
            GLI_ASSERT( TexelCoord.y < Extent.y );
            GLI_ASSERT( TexelCoord.z < Extent.z );
    ...
    inline image::image( std::shared_ptr<storage_linear> Storage, format_type Format, size_type BaseLayer, size_type BaseFace,
                         size_type BaseLevel )
        : Storage( Storage )
        , Format( Format )
        , BaseLevel( BaseLevel )
