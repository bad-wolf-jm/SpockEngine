...
namespace numlua::core
{
    ...
    template <typename T, qualifier P>
    inline typename sampler2d<T, P>::texel_type sampler2d<T, P>::texel_fetch( extent_type const &TexelCoord,
    ...
    template <typename T, qualifier P>
    inline typename sampler2d<T, P>::texel_type sampler2d<T, P>::texture_lod( normalized_type const &SampleCoord,
    ...
    template <typename T, qualifier P>
    inline typename sampler2d<T, P>::texel_type
    sampler2d<T, P>::texture_grad( normalized_type const &SampleCoord, normalized_type const &dPdx, normalized_type const &dPdy ) const
    {
        GLI_ASSERT( !this->Texture.empty() );
        GLI_ASSERT( std::numeric_limits<T>::is_iec559 );
        GLI_ASSERT( this->Filter && this->Convert.Fetch );
