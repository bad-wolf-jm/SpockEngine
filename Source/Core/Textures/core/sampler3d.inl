...
namespace numlua::core
{
    ...
    inline sampler3d<T, P>::sampler3d( texture_type const &Texture, wrap Wrap, filter Mip, filter Min, texel_type const &BorderColor )
        ...
        , Filter( detail::get_filter<filter_type, detail::DIMENSION_3D, texture_type, interpolate_type, normalized_type, fetch_type,
    ...
    template <typename T, qualifier P>
    inline typename sampler3d<T, P>::texel_type sampler3d<T, P>::texel_fetch( extent_type const &TexelCoord,
    ...
    template <typename T, qualifier P>
    GLI_FORCE_INLINE typename sampler3d<T, P>::texel_type sampler3d<T, P>::texture_lod( normalized_type const &SampleCoord,
