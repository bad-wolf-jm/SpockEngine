...
namespace numlua::core
{
    ...
    inline texture3d::texture3d( format_type Format, extent_type const &Extent, swizzles_type const &Swizzles )
        : texture( TARGET_3D, Format, Extent, 1, 1, numlua::core::levels( Extent ), Swizzles )
    {
    }
    ...
    inline texture3d::texture3d( texture const &Texture, format_type Format, size_type BaseLayer, size_type MaxLayer,
    ...
    inline texture3d::texture3d( texture3d const &Texture, size_type BaseLevel, size_type MaxLevel )
