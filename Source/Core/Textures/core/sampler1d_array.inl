...
namespace numlua::core
{
    ...
    inline sampler1d_array<T, P>::sampler1d_array( texture_type const &Texture, numlua::core::wrap Wrap, filter Mip, filter Min,
        ...
        , Filter( detail::get_filter<filter_type, detail::DIMENSION_1D, texture_type, interpolate_type, normalized_type, fetch_type,
    ...
    template <typename T, qualifier P>
    inline typename sampler1d_array<T, P>::texel_type sampler1d_array<T, P>::texel_fetch( extent_type const &TexelCoord,
                                                                                          size_type layer, size_type Level ) const
    {
    ...
    template <typename T, qualifier P>
    inline void sampler1d_array<T, P>::texel_write( extent_type const &TexelCoord, size_type layer, size_type Level,
    ...
    template <typename T, qualifier P>
    inline typename sampler1d_array<T, P>::texel_type sampler1d_array<T, P>::texture_lod( normalized_type const &SampleCoord,
                                                                                          size_type Layer, level_type Level ) const
    {
        GLI_ASSERT( !this->Texture.empty() );
