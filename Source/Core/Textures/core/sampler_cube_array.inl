...
namespace numlua::core
{
    ...
    inline sampler_cube_array<T, P>::sampler_cube_array( texture_type const &Texture, numlua::core::wrap Wrap, filter Mip, filter Min,
        ...
        , Filter( detail::get_filter<filter_type, detail::DIMENSION_2D, texture_type, interpolate_type, normalized_type, fetch_type,
                                     texel_type, T>( Mip, Min, is_border( Wrap ) ) )
    {
    ...
    sampler_cube_array<T, P>::texel_fetch( extent_type const &TexelCoord, size_type layer, size_type Face, size_type Level ) const
    {
    ...
    template <typename T, qualifier P>
    inline void sampler_cube_array<T, P>::texel_write( extent_type const &TexelCoord, size_type layer, size_type Face, size_type Level,
    ...
    template <typename T, qualifier P>
    inline typename sampler_cube_array<T, P>::texel_type sampler_cube_array<T, P>::texture_lod( normalized_type const &SampleCoord,
                                                                                                size_type Layer, size_type Face,
    ...
    inline void sampler_cube_array<T, P>::generate_mipmaps( filter Minification )
    {
        this->generate_mipmaps( this->Texture.base_layer(), this->Texture.max_layer(), this->Texture.base_face(),
                                this->Texture.max_face(), this->Texture.base_level(), this->Texture.max_level(), Minification );
    }
                                                            ...
                                                            filter Minification )
    {
        ...
        detail::generate_mipmaps_2d<texture_type, T, fetch_type, write_type, normalized_type, texel_type>(
            this->Texture, this->Convert.Fetch, this->Convert.Write, BaseLayer, MaxLayer, BaseFace, MaxFace, BaseLevel, MaxLevel,
            Minification );
    }
} // namespace numlua::core
