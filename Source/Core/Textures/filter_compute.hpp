...
namespace numlua::core
{
    namespace detail
    {
        ...
        template <dimension Dimension, typename texture_type, typename interpolate_type, typename normalized_type, typename fetch_type,
                  typename texel_type>
        struct filterBase
        {
            ...
            typedef texel_type ( *filterFunc )( texture_type const &Texture, fetch_type Fetch, normalized_type const &SampleCoordWrap,
                                                size_type Layer, size_type Face, interpolate_type Level,
                                                texel_type const &BorderColor );
        };

        template <dimension Dimension, typename texture_type, typename interpolate_type, typename normalized_type, typename fetch_type,
                  typename texel_type, bool is_float = true, bool support_border = true>
        struct nearest : public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            static texel_type call( texture_type const &Texture, fetch_type Fetch, normalized_type const &SampleCoordWrap,
                                    size_type Layer, size_type Face, size_type Level, texel_type const &BorderColor )
            {
            ...
            public filterBase<DIMENSION_3D, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
                                    ...
                                    size_type Layer, size_type Face, size_type Level, texel_type const &BorderColor )
            {
                ...
                if( Coord.UseTexelFloor.s && Coord.UseTexelFloor.t && Coord.UseTexelFloor.p )
                    Texel000 = Fetch( Texture, extent_type( Coord.TexelFloor.s, Coord.TexelFloor.t, Coord.TexelFloor.p ), Layer, Face,
                                      Level );
        ...
        template <dimension Dimension, typename texture_type, typename interpolate_type, typename normalized_type, typename fetch_type,
                  typename texel_type, bool is_float, bool support_border>
            ...
            public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
            ...
            static texel_type call( texture_type const &Texture, fetch_type Fetch, normalized_type const &SampleCoordWrap,
                                    size_type Layer, size_type Face, interpolate_type Level, texel_type const &BorderColor )
            {
            ...
            public filterBase<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type>
        {
                                    ...
                                    size_type Layer, size_type Face, interpolate_type Level, texel_type const &BorderColor )
            {
                return linear<Dimension, texture_type, interpolate_type, normalized_type, fetch_type, texel_type, is_float,
                              support_border>::call( Texture, Fetch, SampleCoordWrap, Layer, Face, glm::iround( Level ), BorderColor );
            }
        };
