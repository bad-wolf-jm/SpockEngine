...
namespace numlua::core
{
    ...
    class sampler3d : public sampler
    {
      ...
      public:
        ...
        sampler3d( texture_type const &Texture, wrap Wrap, filter Mip = FILTER_NEAREST, filter Min = FILTER_NEAREST,
      ...
      private:
        ...
        typedef typename detail::filterBase<detail::DIMENSION_3D, texture_type, interpolate_type, normalized_type, fetch_type,
