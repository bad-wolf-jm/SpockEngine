...
namespace SE::Core
{
    ...
    // ref_t<DotNetInstance> MarshallComponent( DotNetClass &lMonoType, sNodeTransformComponent &aComponent )
    // {
    ...
    ref_t<DotNetInstance> MarshallComponent( DotNetClass &lMonoType, sTag &aComponent )
    {
    ...
    // ref_t<DotNetInstance> MarshallComponent( DotNetClass &lMonoType, sLightComponent &aComponent )
    // {
