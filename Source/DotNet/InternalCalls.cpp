...
{
    std::vector<ref_t<IGraphicContext>> graphicContexts{};
    std::vector<ref_t<SceneRenderer>>   sceneRenderers{};
    std::vector<ref_t<Scene>>           scenes{};
    ...
    //     ); case eScriptFieldType::Double: return CreateRandomDataMultiTensor<double>( lScope, lShape, eScalarType::FLOAT64, aMean,
    //     aStd ); default: return 0;
    //     }
