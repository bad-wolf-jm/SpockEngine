...
namespace SE::Core::Interop
{
    ...
    void UIComponent_SetBackgroundColor( UIComponent *aSelf, vec4 aColor );
    ...
    void UIBaseImage_SetSize( UIBaseImage *aSelf, vec2 aSize );
    vec2 UIBaseImage_GetSize( UIBaseImage *aSelf );
    void UIBaseImage_SetTopLeft( UIBaseImage *aSelf, vec2 aTopLeft );
    vec2 UIBaseImage_GetTopLeft( UIBaseImage *aSelf );
    void UIBaseImage_SetBottomRight( UIBaseImage *aSelf, vec2 aBottomRight );
    vec2 UIBaseImage_GetBottomRight( UIBaseImage *aSelf );
    void UIBaseImage_SetTintColor( UIBaseImage *aSelf, vec4 aColor );
    ...
    void  UIDropdownButton_SetContentSize( UIDropdownButton *aSelf, vec2 aSize );
    ...
    void  UIDropdownButton_SetTextColor( UIDropdownButton *aSelf, vec4 aColor );
    ...
    void  UILabel_SetTextColor( UILabel *aSelf, vec4 aTextColor );
    ...
    void  UIMenuItem_SetTextColor( UIMenuItem *aSelf, vec4 *aTextColor );
    ...
    void UIPlotData_SetColor( UIPlotData *aSelf, vec4 aColor );
    ...
    vec4  UIAxisTag_GetColor( UIAxisTag *aSelf );
    void  UIAxisTag_SetColor( UIAxisTag *aSelf, vec4 aColor );
    ...
    void  UIProgressBar_SetProgressColor( UIProgressBar *aSelf, vec4 aProgressColor );
    void  UIProgressBar_SetText( UIProgressBar *aSelf, void *aValue );
    void  UIProgressBar_SetTextColor( UIProgressBar *aSelf, vec4 aTextColor );
    ...
    void  UITextInput_SetTextColor( UITextInput *aSelf, vec4 *aTextColor );
    ...
    void  UITextToggleButton_SetActiveColor( UITextToggleButton *aSelf, vec4 *aColor );
    void  UITextToggleButton_SetInactiveColor( UITextToggleButton *aSelf, vec4 *aColor );
    ...
    void  UITreeViewNode_SetTextColor( UITreeViewNode *aSelf, vec4 aTextColor );
    ...
    void  UIVec2Input_SetValue( UIVec2Input *aSelf, vec2 aValue );
    vec2  UIVec2Input_GetValue( UIVec2Input *aSelf );
    void  UIVec2Input_SetFormat( UIVec2Input *aSelf, void *aFormat );
    void  UIVec2Input_SetResetValues( UIVec2Input *aSelf, vec2 aValues );
    ...
    void  UIVec3Input_SetValue( UIVec3Input *aSelf, vec3 aValue );
    vec3  UIVec3Input_GetValue( UIVec3Input *aSelf );
    void  UIVec3Input_SetFormat( UIVec3Input *aSelf, void *aFormat );
    void  UIVec3Input_SetResetValues( UIVec3Input *aSelf, vec3 aValues );
    ...
    void  UIVec4Input_SetValue( UIVec4Input *aSelf, vec4 aValue );
    vec4  UIVec4Input_GetValue( UIVec4Input *aSelf );
    void  UIVec4Input_SetFormat( UIVec4Input *aSelf, void *aFormat );
    void  UIVec4Input_SetResetValues( UIVec4Input *aSelf, vec4 aValues );
    ...
    void  UIDialog_SetSize( UIDialog *aSelf, math::vec2 aSize );
