...
namespace SE::OtdrEditor
{
    ...
    static bool AddChildButton( OtdrScene::Element aNode, math::vec2 aSize )
    {
        char lLabel[128];
    ...
    void OtdrSceneHierarchyPanel::DisplayNode( OtdrScene::Element aNode, float aWidth )
    {
    ...
    void OtdrSceneHierarchyPanel::Display( int32_t width, int32_t height )
    {
