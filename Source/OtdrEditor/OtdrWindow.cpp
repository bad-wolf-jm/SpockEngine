...
namespace SE::Editor
{
    ...
    // void OtdrWindow::UpdateSceneViewport( ImageHandle a_SceneViewport ) { m_SceneViewport = a_SceneViewport; }
...
// #endif
    ...
    math::ivec2 OtdrWindow::GetWorkspaceAreaSize() { return m_WorkspaceAreaSize; }
    ...
    // void OtdrWindow::ClearScene() {}

    // void OtdrWindow::LoadScenario( fs::path aPath )
    // {
    ...
    // void OtdrWindow::ImportModel( fs::path aPath )
    // {
        // auto lName = aPath.filename().string();
        // auto lExt  = aPath.extension().string();
