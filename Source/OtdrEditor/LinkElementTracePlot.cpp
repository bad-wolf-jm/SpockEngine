...
namespace SE::OtdrEditor
{
    ...
    void UILinkElementTracePlot::ConfigureUI()
    {
    ...
    UILinkElementTracePlot::UILinkElementTracePlot( Ref<VkGraphicContext> aGraphicContext, Ref<UIContext> aUIOverlay )
    ...
    bool UILinkElementTracePlot::Display()
    {
    ...
    void UILinkElementTracePlot::LoadIOlmData( fs::path aPath )
    {
    ...
    bool UILinkElementTracePlot::RenderMainMenu()
    {
    ...
    math::ivec2 UILinkElementTracePlot::GetWorkspaceAreaSize() { return mWorkspaceAreaSize; }

    void UILinkElementTracePlot::Update( Timestep aTs )
    {
    ...
    void UILinkElementTracePlot::UpdateFramerate( Timestep ts )
    {
        mFrameCounter++;
        mFpsTimer += (float)ts;
