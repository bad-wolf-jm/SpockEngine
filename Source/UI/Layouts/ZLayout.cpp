...
namespace SE::Core
{
    ...
    UIZLayout::UIZLayout( eZLayoutOrientation aOrientation )
    ...
    void UIZLayout::SetItemSpacing( float aItemSpacing ) { mItemSpacing = aItemSpacing; }
    ...
    void UIZLayout::Add( UIComponent *aChild, float aFixedSize, bool aExpand, bool aFill )
    {
        Add( aChild, 0.0f, aExpand, aFill, eHorizontalAlignment::CENTER, eVerticalAlignment::CENTER );
    }

    void UIZLayout::Add( UIComponent *aChild, float aFixedSize, bool aExpand, bool aFill, eHorizontalAlignment const &aHAlignment,
                         eVerticalAlignment const &aVAlignment )
    {
        mChildren.push_back( ZLayoutItem{ aChild, 0.0f, aExpand, aFill, aHAlignment, aVAlignment } );
    }
