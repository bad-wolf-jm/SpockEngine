...
namespace SE::Core
{
    ...
    void UIWindow::CreatePipeline()
    {
        ...
        lVertexShader->AddFile( "C:\\GitLab\\SpockEngine\\Shaders\\Source\\Common\\Definitions.hpp" );
        lVertexShader->AddFile( "C:\\GitLab\\SpockEngine\\Shaders\\Source\\ImGui.hpp" );
        ...
        lFragmentShader->AddFile( "C:\\GitLab\\SpockEngine\\Shaders\\Source\\Common\\Definitions.hpp" );
        lFragmentShader->AddFile( "C:\\GitLab\\SpockEngine\\Shaders\\Source\\ImGui.hpp" );
