...
int GetTextureWidth( ImTextureID texture ) { return 0; }

int GetTextureHeight( ImTextureID texture ) { return 0; }
...
struct Example // : public Application
{
    ...
    void OnStart()
    {
        ...
        m_HeaderBackground = LoadTexture( "C:\\GitLab\\LTSimulationEngine\\ThirdParty\\imgui-node-editor\\examples\\blueprints-example\\data\\BlueprintBackground.png" );
        m_SaveIcon         = LoadTexture( "C:\\GitLab\\LTSimulationEngine\\ThirdParty\\imgui-node-editor\\examples\\blueprints-example\\data\\ic_save_white_24dp.png" );
        m_RestoreIcon      = LoadTexture( "C:\\GitLab\\LTSimulationEngine\\ThirdParty\\imgui-node-editor\\examples\\blueprints-example\\data\\ic_restore_white_24dp.png" );
    ...
    void ShowLeftPane( float paneWidth )
    {
        ...
        int saveIconWidth     = 15.0f; // GetTextureWidth( m_SaveIcon );
        int saveIconHeight    = 15.0f; // GetTextureWidth( m_SaveIcon );
        int restoreIconWidth  = 15.0f; // GetTextureWidth( m_RestoreIcon );
        int restoreIconHeight = 15.0f; // GetTextureWidth( m_RestoreIcon );
        ...
        for( auto &node : m_Nodes )
        {
            ...
            auto iconPanelPos = start + ImVec2( paneWidth - ImGui::GetStyle().FramePadding.x - ImGui::GetStyle().IndentSpacing - saveIconWidth - restoreIconWidth -
                                                    ImGui::GetStyle().ItemInnerSpacing.x * 1,
                                                ( ImGui::GetTextLineHeight() - saveIconHeight ) / 2 );
            ImGui::GetWindowDrawList()->AddText( ImVec2( iconPanelPos.x - textSize.x - ImGui::GetStyle().ItemInnerSpacing.x, start.y ), IM_COL32( 255, 255, 255, 255 ), id.c_str(),
                                                 nullptr );
