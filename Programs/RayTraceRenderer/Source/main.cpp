...
namespace osc
{
    ...
    {
        SampleWindow( const std::string &title, const Model *model, const Camera &camera, const QuadLight &light,
    ...
    extern "C" int main( int ac, char **av )
    {
        try
        {
            ...
            QuadLight   light      = { /* origin */ math::vec3( -1000 - light_size, 800, -light_size ),
                                /* edge 1 */ math::vec3( 2.f * light_size, 0, 0 ),
                                /* edge 2 */ math::vec3( 0, 0, 2.f * light_size ),
                                /* power */ math::vec3( 3000000.f ) };
